  ...
  return (
    <div className="min-h-screen bg-white flex justify-center">
      <div className={`relative w-[1440px] h-[1931px] bg-white ${inter.className}`}>
              ...
              <thead>
                <tr className="h-[32px]">
                  {['SUN', 'MON', 'TUE', 'WED', 'THU', 'FRI', 'SAT'].map((day, index) => (
                    <th key={day} className="border-r border-b border-[#E5E5E5] text-center font-normal text-[12px] leading-[15px] text-black" style={{ borderRight: index === 6 ? 'none' : undefined }}>
                      {day}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                ...
                <tr className="h-[120px]">
                  {[
                    ...
                    <td key={index} className="border-r border-b border-[#E5E5E5] p-[8px] align-top relative" style={{ borderRight: index === 6 ? 'none' : undefined }}>
                ...
                <tr className="h-[120px]">
                  {['21', '22', '23', '24', '25', '26', '27'].map((day, index) => (
                    <td key={index} className="border-r border-b border-[#E5E5E5] align-top relative" style={{ borderRight: index === 6 ? 'none' : undefined, padding: index === 1 || index === 2 ? '0.5px' : '8px' }}>
                      {index === 1 ? (
                ...
                <tr className="h-[120px]">
                  {[
                    ...
                    <td key={index} className="border-r border-b border-[#E5E5E5] p-[8px] align-top" style={{ borderRight: index === 6 ? 'none' : undefined, borderBottom: 'none' }}>
                      <span className="font-normal text-[12px] leading-[15px]" style={{ color: item.color }}>
                        {item.day}
                      </span>
                    </td>
        ...
        {/* Top horizontal line */}
        <div className="absolute w-[1440px] h-[1px] left-0 top-[117px] bg-[#E5E5E5]"></div>
        
        {/* Bottom horizontal line */}
        <div className="absolute w-[1440px] h-[1px] left-0 top-[846px] bg-[#E5E5E5]"></div>
        
        {/* Left vertical line */}
        <div className="absolute w-[1px] h-[729px] left-[100px] top-[117px] bg-[#E5E5E5]"></div>
        
        {/* Right vertical line */}
        <div className="absolute w-[1px] h-[729px] left-[1340px] top-[117px] bg-[#E5E5E5]"></div>
        
        {/* Corner connecting lines */}
        <div className="absolute w-[100px] h-[1px] left-0 top-[117px] bg-[#E5E5E5]"></div>
        <div className="absolute w-[100px] h-[1px] left-[1340px] top-[117px] bg-[#E5E5E5]"></div>
        <div className="absolute w-[100px] h-[1px] left-0 top-[846px] bg-[#E5E5E5]"></div>
        <div className="absolute w-[100px] h-[1px] left-[1340px] top-[846px] bg-[#E5E5E5]"></div>
      </div>
    </div>
  );
}
